  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-sidebar flex flex-col z-50">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <NavItem icon={<BookOpen className="w-5 h-5" />} label="My Courses" badge={3} />
        <NavItem icon={<GraduationCap className="w-5 h-5" />} label="Certifications" />
        <NavItem icon={<Calendar className="w-5 h-5" />} label="Schedule" badge={2} />
